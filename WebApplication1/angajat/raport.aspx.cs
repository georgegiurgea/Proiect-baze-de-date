...
namespace WebApplication1.angajat
{
    public partial class raport : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select ang.Nume,ang.Prenume,ang.Salariu from Angajat ang inner join Departamente dep on" +
                " dep.IDDepartament = ang.IDDepartament where dep.NumeDepartament = '" + txtNume.Text + "'";
            cmd.Connection = con;
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand();
            cmd.CommandText = "Select a.Nume,a.Prenume,dep.NumeDepartament from Angajat a inner join Departamente dep " +
                "on a.IDDepartament=Dep.IDDepartament where a.Functie='" + txtFunctie.Text + "'";
            cmd.Connection = con;
            SqlDataReader rd = cmd.ExecuteReader();
            table.Append("<table class='GeneratedTable' border='1' >");
