...
{
    public partial class RaportChelClad : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "Select cl.Denumire,cl.Valoare,cl.Data from Cheltuieli_Cladiri cl where cl.IDCladire in " +
                "(select IDCladire from Cladiri where IDCladire='" + TextBox1.Text + "') order by cl.Data ASC";
            cmd.Connection = con;
